...
Public Class rptSuCitaPaciente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Orthosoft.rptSuCitaPaciente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSuCitaPaciente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSuCitaPaciente = New rptSuCitaPaciente
        rpt.Site = Me.Site
        Return rpt
    End Function
