...
Public Class rptCitasSinAsistir
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Orthosoft.rptCitasSinAsistir.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCitasSinAsistir
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCitasSinAsistir = New rptCitasSinAsistir
        rpt.Site = Me.Site
        Return rpt
    End Function
