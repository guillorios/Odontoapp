...
Public Class rptHistoriaClinicaOrto3
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptHistoriaClinicaOrto3.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Orthosoft.rptHistoriaClinicaOrto3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptHistoriaClinicaOrto3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHistoriaClinicaOrto3 = New rptHistoriaClinicaOrto3
        rpt.Site = Me.Site
        Return rpt
    End Function
