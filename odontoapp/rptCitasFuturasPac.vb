...
Public Class rptCitasFuturasPac
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Orthosoft.rptCitasFuturasPac.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCitasFuturasPac
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCitasFuturasPac = New rptCitasFuturasPac
        rpt.Site = Me.Site
        Return rpt
    End Function
