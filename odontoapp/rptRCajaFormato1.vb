...
Public Class rptRCajaFormato1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Orthosoft.rptRCajaFormato1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRCajaFormato1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRCajaFormato1 = New rptRCajaFormato1
        rpt.Site = Me.Site
        Return rpt
    End Function
