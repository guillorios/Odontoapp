...
Public Class rptHistoriaClinicaOrto2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptHistoriaClinicaOrto2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Orthosoft.rptHistoriaClinicaOrto2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptHistoriaClinicaOrto2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHistoriaClinicaOrto2 = New rptHistoriaClinicaOrto2
        rpt.Site = Me.Site
        Return rpt
    End Function
