...
Public Class rptCumpleaños
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Orthosoft.rptCumpleaños.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCumpleaños
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCumpleaños = New rptCumpleaños
        rpt.Site = Me.Site
        Return rpt
    End Function
