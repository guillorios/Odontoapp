...
Public Class rptCEgresoFormato1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Orthosoft.rptCEgresoFormato1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCEgresoFormato1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCEgresoFormato1 = New rptCEgresoFormato1
        rpt.Site = Me.Site
        Return rpt
    End Function
