...
Public Class rptRCajaFormato2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Orthosoft.rptRCajaFormato2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRCajaFormato2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRCajaFormato2 = New rptRCajaFormato2
        rpt.Site = Me.Site
        Return rpt
    End Function
