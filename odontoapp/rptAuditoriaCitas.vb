...
Public Class rptAuditoriaCitas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Orthosoft.rptAuditoriaCitas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAuditoriaCitas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAuditoriaCitas = New rptAuditoriaCitas
        rpt.Site = Me.Site
        Return rpt
    End Function
