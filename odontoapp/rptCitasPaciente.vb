...
Public Class rptCitasPaciente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Orthosoft.rptCitasPaciente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCitasPaciente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCitasPaciente = New rptCitasPaciente
        rpt.Site = Me.Site
        Return rpt
    End Function
