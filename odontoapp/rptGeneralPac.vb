...
Public Class rptGeneralPac
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Orthosoft.rptGeneralPac.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGeneralPac
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGeneralPac = New rptGeneralPac
        rpt.Site = Me.Site
        Return rpt
    End Function
